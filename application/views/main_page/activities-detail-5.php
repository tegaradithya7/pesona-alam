<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/activity-bg-6.jpg);">
				<div class="inner">
					<h1 class="title">Horse Riding</h1>
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						After a work hard <br>
						like a horse <br>
						<span>It's time to ride them</span>
					</div>
				</div>
				<div class="subtitle-1 ta-center">
					As the name implies, we offer a variety of activities related to equestrian sports. Visitors can try to ride a horse, or learn more by attending coaching classes
				</div>
			</div>
			<div class="slider">
