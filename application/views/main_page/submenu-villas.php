<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/submenu-villas-bg.jpg);">
				<div class="inner">
		...
		<div class="frame-master section-2">
			...
			<img src="assets/images/accent-pine-cone.png" alt="" class="accent accent-2">
				...
				<div class="row">
					<div class="col-6">
						<div class="slide-wrapper">
							<div class="slide" style="background-image: url(assets/images/villa-superior-3-bedroom.jpg);"></div>
							<div class="slide" style="background-image: url(assets/images/villa-superior-2-bedroom.jpg);"></div>
						</div>
					</div>
					<div class="col-6">
						<div class="info-wrapper">
							<div class="title">Villa Superior 1 Bedroom</div>
							<div class="subtitle">
								The 25 sqm Pesona Alam Room pure WHITE with ORANGE touch, make for a cool, fun and spirited atmosphere,
							</div>
							<div class="accordion-wrapper">
								<div class="accordion-title"></div>
								<div class="accordion-group">
				                  <div class="accordion">
				                    <div class="accordion-header all-caps" id="heading1">EQUIPMENTS<i class="pull-right fas fa-chevron-down"></i></div>
				                    <div class="collapse" id="collapse1">
				                      <div class="accordion-body">
										<ul>
											<li>HD TV 60 channels</li>
											<li>Bluetooth radio and alarm clock</li>
											<li>Safe</li>
											<li>Cordless phone</li>
											<li>Air conditioning (summer period)</li>
										</ul>
				                      </div>
				                    </div>
				                  </div>
			...
			<div class="inner-with-slide">
				<div class="row">
					<div class="col-6">
						<div class="info-wrapper">
							<div class="title">Villa Superior 2 Bedroom</div>
							<div class="subtitle">
								The 25 sqm Pesona Alam Room pure WHITE with ORANGE touch, make for a cool, fun and spirited atmosphere,
							</div>
							<div class="accordion-wrapper">
			...
			<div class="inner-with-slide">
				<div class="row">
					...
					<div class="col-6">
						<div class="info-wrapper">
							<div class="title">Villa deluxe 2 bedroom</div>
							<div class="subtitle">
								The 25 sqm Pesona Alam Room pure WHITE with ORANGE touch, make for a cool, fun and spirited atmosphere,
							</div>
							<div class="accordion-wrapper">
			...
			<div class="inner-with-slide">
				<div class="row">
					<div class="col-6">
						<div class="info-wrapper">
							<div class="title">Villa deluxe 3 bedroom</div>
							<div class="subtitle">
								The 25 sqm Pesona Alam Room pure WHITE with ORANGE touch, make for a cool, fun and spirited atmosphere,
							</div>
							<div class="accordion-wrapper">
