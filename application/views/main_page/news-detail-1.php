...
$img = explode(',', $detail_data[$type . '_file']);
// print_r($img);die;

if ($detail_data['date'] == '' || $detail_data['date'] == null || $detail_data['date'] == '0000-00-00') {
	$date = date('l, d M Y', strtotime(date('Y-m-d')));
} else {
	$date = date('l, d M Y', strtotime($detail_data['date']));
}
...
<body class="master-body submenu-1 news">
	...
	<div class="fullwidth-master section-header slider-init">
		<div class="header" style="background-image: url(<?php echo base_url('assets/lampiran/' . $type . '_file' . '/' . $img[0]) ?>);">
			<div class="inner">
				<h1 class="title"><?php echo ($data['type'] == 'news') ? 'News' : 'Offers'; ?></h1>
	...
	<div class="frame-master section-1">
		...
		<div class="inner d-flex ai-center fd-col">
			...
			<div class="title-1 ta-center">
				<span class="signature-title"><?php echo ($data['type'] == 'news') ? 'Newsletter' : 'Promotion'; ?></span>
		...
		<div class="slider">
			<div class="slider-wrapper">
				...
				?>
					<div class="slide">
						<div class="bg-img" style="background-image: url(<?php echo base_url('assets/lampiran/' . $type . '_file' . '/' . $value) ?>);">
