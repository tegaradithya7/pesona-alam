<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/activity-bg-9.jpg);">
				<div class="inner">
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						Have a break <br>
						<span>Let's play ping pong</span>
					</div>
				</div>
				<div class="subtitle-1 ta-center">
					Make the break time feels little bit competitive, make your time with table tennis league. Anyone who haven't ever played one? Let's grab those and ping pong time!
				</div>
			</div>
			<div class="slider">
