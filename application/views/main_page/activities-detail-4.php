<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/activity-bg-5.jpg);">
				<div class="inner">
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						Beacuse memories aren't made <br>
						<span>Let's play, folks.</span>
					</div>
				</div>
				<div class="subtitle-1 ta-center">
					Go play, two words that lead to active and engaged exploration & discovery. It isn't only for the children, adult should be down for a game night too.
				</div>
			</div>
			<div class="slider">
