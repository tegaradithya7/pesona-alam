<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/activity-bg-8.jpg);">
				<div class="inner">
					<h1 class="title">Paint Ball Pine Forest</h1>
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						shoot the shot<br>
						<span>feel the thrill</span>
					</div>
				</div>
				<div class="subtitle-1 ta-center">
					In Pesona Alam, we truly put essence of togetherness in another level. The Pine Forest isn't only a place for you to catch fresh air and inner peace, but also can bring you to the thrill of fun againts your friendly co-workers. Let the war of paint begin!
				</div>
			</div>
			<div class="slider">
