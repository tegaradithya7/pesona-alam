<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 news">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(<?php echo base_url('main_assets/assets/images/header-bg-3.jpg') ?>);">
				<div class="inner">
					<h1 class="title">News</h1>
					<p class="subtitle">keep up to date with pesona alam</p>
				</div>
			</div>
		</div>
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						Our News letter <br>
						<span>We keep everything updated</span>
					</div>
				</div>
			</div>
			<div class="card-wrapper">
				...
				<?php } ?>
								<div class="col-4">
									<div class="card">
										<?php if ($cover[0] == '') { ?>
											<div class="bg-img" style="background-image: url(<?php echo base_url('assets/lampiran/news_file/'.$value['news_file']) ?>);" id="<?php echo $value['id'] ?>">
										<?php } else { ?>
											<div class="bg-img" style="background-image: url(<?php echo base_url('assets/lampiran/news_file/'.$cover[0]) ?>);" id="<?php echo $value['id'] ?>">
										<?php } ?>
											<div class="card-info">
												<div class="info-date">
		...
		<script>
			$(document).ready(function() {
				...
				$('.card .bg-img').click(function() {
					var id = $(this).attr('id');
					// alert(id);
					var url = "<?php echo site_url('menu/detail') ?>/"+id;
