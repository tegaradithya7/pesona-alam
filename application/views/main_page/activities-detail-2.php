<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/activity-bg-3.jpg);">
				<div class="inner">
					<h1 class="title">Archery Field</h1>
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						Hit your best shot <br>
						<span>while counting 1, 2, 3</span>
					</div>
				</div>
				<div class="subtitle-1 ta-center">
					This wide open green grass field will be your another level challange. do you ever try archery before? Our profesional Archery coach will teach you how to hit the 10 like ease. Believe us, the kids love it.
				</div>
			</div>
			<div class="slider">
