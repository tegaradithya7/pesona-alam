<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/activity-bg-4.jpg);">
				<div class="inner">
					<h1 class="title">Billiard</h1>
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						Stroke it, don’t poke it <br>
						<span>Shoot Good, play better</span>
					</div>
				</div>
				<div class="subtitle-1 ta-center">
					Test your skill versus your co-workers luck. You can have a relax conversations between co-workers after a long trip and meeting, The Lucky 8 Ball is waiting to be shoot. 
				</div>
			</div>
			<div class="slider">
