<?php 
	$img = explode(',', $detail['activities_file']);
?>
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(<?php echo base_url('assets/lampiran/activities_file/'.$img[0]) ?>);">
				<div class="inner">
		...
		<div class="frame-master section-1">
			...
			<div class="slider">
				<div class="slider-wrapper">
					...
					?>
						<div class="slide">
							<div class="bg-img" style="background-image: url(<?php echo base_url('assets/lampiran/activities_file/'.$value) ?>);">
