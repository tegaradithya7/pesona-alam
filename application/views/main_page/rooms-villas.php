	...
	<div class="frame-master section-1">
		...
		<div class="slider">
			<div class="slider-wrapper">
				...
				?>
					<div class="slide">
						<div class="bg-img" style="background-image: url(<?php echo base_url('assets/lampiran/rooms_villas_file/' . $value['rooms_villas_file']) ?>)" onclick="location.href='<?php echo site_url('menu/rooms') ?>'">
							<div class="slide-info">
								<div class="info-title">
									<?= $value['name'] ?>
								</div>
								<div class="info-content">
									<span><i class="fas fa-expand-arrows-alt"></i><?= $value['size'] ?> m²</span>
									<span><i class="fas fa-users"></i><?= $value['capacity'] ?> person</span>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="fullwidth-master section-3">
		...
		<div class="slider">
			...
			<div class="slider-wrapper">
				...
				?>
					<div class="slide">
						<div class="bg-img" style="background-image: url(<?php echo base_url('assets/lampiran/rooms_villas_file/' . $value['rooms_villas_file']) ?>)" onclick="location.href='<?php echo site_url('menu/villas') ?>'">

							<div class="info-wrapper">
								<div class="slide-title"><?php echo $value['name'] ?></div>
