<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="master-body submenu-1 activities">
		...
		<div class="fullwidth-master section-header slider-init">
			<div class="header" style="background-image: url(assets/images/activity-bg-7.jpg);">
				<div class="inner">
					<h1 class="title">Karoeke Room</h1>
			...
			<div class="inner d-flex ai-center fd-col">
				<div class="title-1 ta-center">
					...
					<div class="regular-title">
						don't stop retrieving <br>
						<span>hold on to what you sing</span>
					</div>
				</div>
				<div class="subtitle-1 ta-center">
					Karaoke activities are indeed fun, especially when done with close people. Reach for the microphone and let your voice sing throughout the room
				</div>
			</div>
			<div class="slider">
