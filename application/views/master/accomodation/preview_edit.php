...
<body class="master-body submenu-1 news">
	<nav class="nav">
		<div class="row">
			...
			<div class="col-4 d-flex jc-center">
				<img src="../../../../../assets/images/logo.png" alt="" class="nav-logo" onclick="location.href='index.php'">
			</div>
			<div class="col-4 d-flex ai-center">
	...
	<div class="fullmenu">
		<img src="../../../../../assets/images/logo.png" alt="" class="fullmenu-logo">
		<div class="logo-group">
			<img src="../../../../../assets/images/logo-all-sedayu.png" alt="" class="">
			<img src="../../../../../assets/images/logo-tauzia.png" alt="" class="">
		</div>
		<div class="inner">
	...
	<div class="fullwidth-master section-header slider-init">
		<div class="header" style="background-image: url(../../../../assets/lampiran/<?php echo $file ?>/<?php echo $img[1] ?>);">
			<div class="inner">
	...
	<div class="frame-master section-1">
		...
		<div class="slider">
			<div class="slider-wrapper">
				...
				?>
					<div class="slide">
						<div class="bg-img" style="background-image: url(../../../../assets/lampiran/<?php echo $file ?>/<?php echo $value ?>);">
	...
	<div class="footer">
		<img src="../../../../../assets/images/footer-accent-1.png" alt="" class="footer-accent-1">
		<img src="../../../../../assets/images/footer-accent-2.png" alt="" class="footer-accent-2">
		<div class="inner">
			<div class="row">
				<div class="col-3">
					<img src="../../../../../assets/images/logo-colored.png" alt="" class="footer-logo">
				</div>
				<div class="col-9">
					<div class="row">
						<div class="col-4">
...
<form action="<?php echo base_url('master/accomodation/' . $url . '/' . $id) ?>" method="POST" enctype="multipart/form-data">
